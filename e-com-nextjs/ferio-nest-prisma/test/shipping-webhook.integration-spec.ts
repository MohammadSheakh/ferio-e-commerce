...
const shipping = new ShippingService(
  ...
  new (require('../src/features/shipping/adapters/redx.adapter').RedxAdapter)(
    config,
  ),
  new (require('../src/features/shipping/adapters/ecourier.adapter').EcourierAdapter)(
    config,
  ),
  new (require('../src/features/shipping/adapters/paperfly.adapter').PaperflyAdapter)(
    config,
  ),
