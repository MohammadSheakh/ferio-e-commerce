...
const inputClass =
  "w-full rounded-card border border-line px-3.5 py-2.5 text-[14px] focus:border-ink";
    ...
    <div ref={containerRef} className="relative w-full">
      ...
      <div className="relative">
        ...
        {selectedId ? (
          ...
          <span className="absolute right-3 top-1/2 -translate-y-1/2 rounded-full bg-surface px-2 py-0.5 text-[10px] font-medium text-ink2">
            One-off
          </span>
        ) : null}
      </div>
      ...
      {isOpen && (
        <div className="absolute z-30 mt-1 max-h-60 w-full overflow-y-auto rounded-card border border-line bg-white">
          ...
          {query.trim().length > 0 && !exactMatch && (
            <div className="border-t border-line p-2 space-y-1 bg-neutral-50">
              ...
              >
                <span>
                  ➕ Create & Save &quot;{query.trim()}&quot; as reusable Brand
                </span>
              </button>
              ...
              >
                <span>
                  🏷️ Use &quot;{query.trim()}&quot; as one-off text (don&apos;t
                  save)
                </span>
              </button>
            </div>
