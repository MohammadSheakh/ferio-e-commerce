...
| BO-06 | CI lacks lint, frontend/mobile tests, migration verification, image smoke tests, and strict dependency failure policy. | IN PROGRESS | Backend `lint` is now read-only; mobile typecheck, dependency audit, and tenant/platform migration deployment are covered, while lint, frontend tests, image smoke tests, and strict audit failures remain open. |
